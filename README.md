...
- **Orange Data Mining** (version 3.x or later)
  - Download from: [https://orangedatamining.com/download/](https://orangedatamining.com/download/)
...
2. Install Orange Data Mining if you haven't already:
   - Visit the [official download page](https://orangedatamining.com/download/)
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/Mahmoud7111/orange-ml-classification-project/issues).
...
- [Orange Tutorials](https://orangedatamining.com/widget-catalog/)
